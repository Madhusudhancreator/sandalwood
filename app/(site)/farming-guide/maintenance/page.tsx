import { getMaintenancePageData } from "@/lib/sanity/queries/farmingGuide";
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return { title: data?.seo?.metaTitle ?? "Maintenance Guide", description: data?.seo?.metaDescription ?? "" };
}
...
export default async function MaintenancePage() {
  ...
  return (
    <>
      <PageHero title={data?.title ?? "Maintenance"} breadcrumb={[{ label: "Home", href: "/" }, { label: "Farming Guide", href: "/farming-guide" }, { label: "Maintenance" }]} />
